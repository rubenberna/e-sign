<template>
  <div class="easy-footer">
    ...
    <p class="footer-copy"><span>&copy; {{ year }} Easy Life &bull;</span> <a href="https://easylife-dc.be/nl/disclaimer"> Disclaimer</a> <span> &bull; </span> <a href="https://easylife-dc.be/nl/privacy">Privacy</a></p>
  </div>
</template>
