  ...
  <div class="search-board">
    ...
    <div class="search-board-content">
      ...
      <div class="search-board-cta">
        ...
        <div v-else>
          <SearchContact 
            v-if="contact === null || contact === 'not_found'"
            @setFlash="flashOn"/>
          <safety-question-modal v-else-if="contact.Signed_Contract__c || contractForm.signed" 
          />
...
<script>
  ...
  import SafetyQuestionModal from '@/components/modal/SafetyQuestionModal'
